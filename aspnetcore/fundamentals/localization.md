...
1. 在方案總管中，以滑鼠右鍵按一下要放置資源檔的資料夾 > [新增] > [新增項目]。
    ...
    ![巢狀的操作功能表：在 方案總管操作功能表是開啟 資源。 接著針對 [新增] 開啟第二個特色選單，並反白顯示 [新增項目] 命令。](localization/_static/newi.png)
...
* 當地語系化 (L10N):自訂特定的語言和區域的應用程式的程序。
* 國際化 (I18N):全球化和當地語系化描述。
* 文化特性：它是一種語言和 （選擇性） 地區。

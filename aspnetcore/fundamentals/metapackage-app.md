...
* 會產生下列警告：
     ...
     *警告 NU1604:專案相依性 Microsoft.AspNetCore.App 不包含下限 （內含）。請在相依性版本包含下限，以確保還原結果一致。*
...
* 在開發電腦和組建伺服器：下載並安裝[.NET Core SDK](https://www.microsoft.com/net/download)。
* 在 部署伺服器：下載並安裝[.NET Core 執行階段](https://www.microsoft.com/net/download)。

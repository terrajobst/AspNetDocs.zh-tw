...
安裝 Docker，請先檢閱的資訊[Docker for Windows:What to know before you install](https://docs.docker.com/docker-for-windows/install/#what-to-know-before-you-install) (安裝前須知) 中的資訊。 接下來，安裝 [適用於 Windows 的 Docker](https://docs.docker.com/docker-for-windows/install/)。
...
Visual Studio 2017 版本 15.8 或更新版本只有在指示進行時，才會新增協調流程解決方案。 以滑鼠右鍵按一下**方案總管**中的專案，然後選取 [新增] > [容器協調器支援]。 提供兩個不同的選擇：[Docker Compose](#docker-compose)並[Service Fabric](#service-fabric)。
...
* [Azure Service Fabric:準備開發環境](/azure/service-fabric/service-fabric-get-started)

...
> 
> 請在本主題，參閱這段影片，如需詳細資訊：[在 ASP.NET 中使用基本的表單驗證](# "using-basic-forms-authentication-in-aspnet")。
...
## <a name="step-1-creating-an-aspnet-website-for-this-tutorial-series"></a>步驟 1：本教學課程系列中建立 ASP.NET 網站
...
首先新增名為 LoginContent 轉換成主版頁面內巡覽 ContentPlaceHolder &lt;div&gt;項目。 您只需拖曳 ContentPlaceHolder 控制項從 [工具箱] 拖曳至來源檢視中，將放置產生的標記正上方的待辦事項：功能表將在此處呈現的文字。

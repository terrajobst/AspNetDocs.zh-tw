...
[![F比爾蓋茲新頁面已新增至 [成員資格] 資料夾](creating-user-accounts-vb/_static/image2.png)](creating-user-accounts-vb/_static/image1.png)
...
[![Add 專案的根目錄的檔名為 Web.sitemap](creating-user-accounts-vb/_static/image5.png)](creating-user-accounts-vb/_static/image4.png)

**圖 2**:新增名為檔案`Web.sitemap`專案的根目錄 ([按一下以檢視完整大小的影像](creating-user-accounts-vb/_static/image6.png))
...
[![T他網站導覽代表階層式導覽結構](creating-user-accounts-vb/_static/image8.png)](creating-user-accounts-vb/_static/image7.png)
...
若要建立此介面，加入下列宣告式標記`Site.master`主版頁面的左側資料行位置的文字待辦事項：功能表放在這裡...目前位於。
...
[![T他巡覽使用者介面會轉譯使用巢狀未排序清單](creating-user-accounts-vb/_static/image11.png)](creating-user-accounts-vb/_static/image10.png)
...
[![T他的階層連結會顯示目前頁面和其祖系網站導覽中](creating-user-accounts-vb/_static/image14.png)](creating-user-accounts-vb/_static/image13.png)
...
[![Add CreatingUserAccounts.aspx 頁面各種 Web 控制項](creating-user-accounts-vb/_static/image17.png)](creating-user-accounts-vb/_static/image16.png)

**圖 6**:將各種 Web 控制項加入`CreatingUserAccounts.aspx Page`([按一下以檢視完整大小的影像](creating-user-accounts-vb/_static/image18.png))


`SecurityQuestion`標籤和`SecurityAnswer`文字方塊所顯示的預先定義的安全性問題並收集使用者的回應。 請注意，安全性問題和答案會儲存在使用者的使用者為基礎，因此可允許每個使用者定義自己的安全性問題。 不過，此範例中，我已決定使用通用的安全性問題，也就是：什麼是您最愛的色彩？
...
[![A 新的使用者帳戶已成功建立](creating-user-accounts-vb/_static/image20.png)](creating-user-accounts-vb/_static/image19.png)

**圖 7**:新的使用者帳戶已成功建立 ([按一下以檢視完整大小的影像](creating-user-accounts-vb/_static/image21.png))


[![T因為提供的密碼太弱時，他的使用者帳戶不會建立](creating-user-accounts-vb/_static/image23.png)](creating-user-accounts-vb/_static/image22.png)

**圖 8**:因為提供的密碼太弱，不會建立使用者帳戶 ([按一下以檢視完整大小的影像](creating-user-accounts-vb/_static/image24.png))


[![T他的使用者帳戶是未建立的因為使用者名稱是使用中](creating-user-accounts-vb/_static/image26.png)](creating-user-accounts-vb/_static/image25.png)

**圖 9**:使用者帳戶是未建立因為使用者名稱已在使用 ([按一下以檢視完整大小的影像](creating-user-accounts-vb/_static/image27.png))
...
[![T以下是兩個使用者成員資格使用者存放區中：Tito 和 Bruce](creating-user-accounts-vb/_static/image29.png)](creating-user-accounts-vb/_static/image28.png)

**圖 10**:在 成員資格使用者存放區中有兩位使用者：Tito 和 Bruce ([按一下以檢視完整大小的影像](creating-user-accounts-vb/_static/image30.png))
...
[![T他 CreateUserWizard 控制項呈現一般的建立使用者介面](creating-user-accounts-vb/_static/image32.png)](creating-user-accounts-vb/_static/image31.png)
...
[![T他 CreateUserWizard 自動會將驗證控制項](creating-user-accounts-vb/_static/image35.png)](creating-user-accounts-vb/_static/image34.png)
...
[![A 新的使用者帳戶已成功建立](creating-user-accounts-vb/_static/image38.png)](creating-user-accounts-vb/_static/image37.png)
...
[![T他 CreateUserWizardStep 含有 [取消] 按鈕](creating-user-accounts-vb/_static/image41.png)](creating-user-accounts-vb/_static/image40.png)
...
[![U不允許使用之前端邊緣或尾端空格的 sernames](creating-user-accounts-vb/_static/image44.png)](creating-user-accounts-vb/_static/image43.png)

**圖 15**:不允許使用使用者名稱與之前端邊緣或尾端空格 ([按一下以檢視完整大小的影像](creating-user-accounts-vb/_static/image45.png))

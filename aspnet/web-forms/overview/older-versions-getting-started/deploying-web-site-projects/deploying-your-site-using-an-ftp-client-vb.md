...
**圖 1**：使用 FTP 用戶端，將所需的檔案從桌面複製到 Web 主機提供者的 web 伺服器（[按一下以觀看完整大小的影像](deploying-your-site-using-an-ftp-client-vb/_static/image3.png)）
...
[**圖 3**]：使用 FTP 用戶端，將所需的檔案從桌面複製到 Web 主機提供者的 web 伺服器（[按一下以觀看完整大小的影像](deploying-your-site-using-an-ftp-client-vb/_static/image9.png)）

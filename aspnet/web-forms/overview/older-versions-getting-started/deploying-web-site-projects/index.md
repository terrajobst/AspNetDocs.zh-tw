...
> ASP.NET web 應用程式通常會設計、 建立，並在本機開發環境和需求部署至生產環境中，當其就緒版本進行測試。 本教學課程系列會詳細說明部署程序。
...
- [設定使用應用程式服務的網站 (C#)](configuring-a-website-that-uses-application-services-cs.md)
- [資料庫開發及部署策略 (C#)](strategies-for-database-development-and-deployment-cs.md)
- [顯示自訂的錯誤頁面 (C#)](displaying-a-custom-error-page-cs.md)
- [處理未處理的例外狀況 (C#)](processing-unhandled-exceptions-cs.md)
- [使用 ASP.NET 狀況監控記錄錯誤的詳細資料 (C#)](logging-error-details-with-asp-net-health-monitoring-cs.md)
- [使用 ELMAH 記錄錯誤的詳細資料 (C#)](logging-error-details-with-elmah-cs.md)
- [先行編譯您的網站 (C#)](precompiling-your-website-cs.md)
- [生產環境網站的使用者和角色 (C#)](users-and-roles-on-the-production-website-cs.md)
...
- [設定使用應用程式服務的網站 (VB)](configuring-a-website-that-uses-application-services-vb.md)
- [資料庫開發及部署策略 (VB)](strategies-for-database-development-and-deployment-vb.md)
- [顯示自訂的錯誤頁面 (VB)](displaying-a-custom-error-page-vb.md)

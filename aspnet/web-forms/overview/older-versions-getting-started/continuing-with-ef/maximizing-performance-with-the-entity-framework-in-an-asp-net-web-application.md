...
- [如何：預先產生檢視以改善查詢效能](https://msdn.microsoft.com/library/bb896240.aspx)MSDN 網站上。 說明如何使用`EdmGen.exe`命令列工具來預先產生檢視表。
...
- [使用 Entity Framework 與 ObjectDataSource:自訂分頁](http://geekswithblogs.net/Frez/articles/using-the-entity-framework-and-the-objectdatasource-custom-paging.aspx)。 建置 ContosoUniversity 建立的應用程式在這些教學課程說明如何實作中的分頁的部落格文章*Departments.aspx*頁面。

...
注意:如果您在此時收到下列對話方塊中，您不必建置專案後再繼續。
...
在 **選擇資料來源**步驟中，選取**DepartmentsEntityDataSource**做為資料來源中，按一下 **重新整理結構描述**，然後選取 **名稱**為要顯示的資料欄位並**DepartmentID**做為值的資料欄位。 按一下 [確定] 。

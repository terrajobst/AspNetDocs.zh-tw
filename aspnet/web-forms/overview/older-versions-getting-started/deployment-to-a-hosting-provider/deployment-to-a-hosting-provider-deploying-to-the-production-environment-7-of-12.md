...
---
# <a name="deploying-an-aspnet-web-application-with-sql-server-compact-using-visual-studio-or-visual-web-developer-deploying-to-the-production-environment---7-of-12"></a>部署 ASP.NET Web 應用程式與 SQL Server Compact 使用 Visual Studio 或 Visual Web Developer:部署到生產環境-12 個 7
...
在 **檔案管理員**方塊中，選取**contosouniversity.com** ，然後**wwwroot**若要查看應用程式的根資料夾。 按一下 掛鎖圖示旁**Elmah**。

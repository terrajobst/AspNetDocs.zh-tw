...
存取被拒絕。 (發生例外狀況於 HRESULT:0x80070005 (E\_ACCESSDENIED))
...
如需如何編輯專案檔中的 PreSource 項目資訊，請參閱[How to:編輯專案檔中的部署設定](https://msdn.microsoft.com/library/ff398069(v=vs.100).aspx)。 如果需要在目的地資料庫中的使用者或開發資料庫中的角色，請連絡您的主機服務提供者尋求協助。

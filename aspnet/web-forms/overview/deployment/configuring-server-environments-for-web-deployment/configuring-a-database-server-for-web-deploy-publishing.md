...
如需有關設定適用於 SQL Server 的 Windows 防火牆，特別是如果您需要透過標準或動態連接埠與 SQL Server 通訊，請參閱[How to:設定用於 Database Engine 存取的 Windows 防火牆](https://technet.microsoft.com/library/ms175043.aspx)。

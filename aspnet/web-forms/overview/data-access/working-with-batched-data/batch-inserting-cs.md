...
[![T他批次插入介面](batch-inserting-cs/_static/image2.png)](batch-inserting-cs/_static/image1.png)
...
[![Drag 面板，以從 [工具箱] 拖曳至設計工具](batch-inserting-cs/_static/image5.png)](batch-inserting-cs/_static/image4.png)
...
[![Display 從 ProductsBLL 類別的 GetProducts 方法傳回的資料](batch-inserting-cs/_static/image8.png)](batch-inserting-cs/_static/image7.png)

**圖 3**:顯示從傳回的資料`ProductsBLL`類別 s`GetProducts`方法 ([按一下以檢視完整大小的影像](batch-inserting-cs/_static/image9.png))


[![Set 下拉式清單中更新、 插入和刪除索引標籤，為 [（無）](batch-inserting-cs/_static/image11.png)](batch-inserting-cs/_static/image10.png)
...
[![T他的 GridView 會列出產品和提供排序和分頁功能](batch-inserting-cs/_static/image14.png)](batch-inserting-cs/_static/image13.png)
...
[![T插入介面由所組成的他的四資料行，七個資料列的資料表](batch-inserting-cs/_static/image17.png)](batch-inserting-cs/_static/image16.png)
...
[![C設定要使用 SuppliersBLL 類別的 GetSuppliers 方法的 ObjectDataSource](batch-inserting-cs/_static/image20.png)](batch-inserting-cs/_static/image19.png)
...
[![Display 供應商資料] 欄位和做為值使用 SupplierID](batch-inserting-cs/_static/image23.png)](batch-inserting-cs/_static/image22.png)

**圖 8**:顯示`CompanyName`資料欄位並使用`SupplierID`的值 ([按一下以檢視完整大小的影像](batch-inserting-cs/_static/image24.png))
...
[![T此外，他標頭資料列現在會包含供應商和類別 dropdownlist 進行](batch-inserting-cs/_static/image26.png)](batch-inserting-cs/_static/image25.png)
...
[![T他插入介面現在包含文字方塊的產品名稱和價格](batch-inserting-cs/_static/image29.png)](batch-inserting-cs/_static/image28.png)
...
[![P取代 statuslabel 設控制上述兩個面板控制項](batch-inserting-cs/_static/image32.png)](batch-inserting-cs/_static/image31.png)

**圖 11**:地方`StatusLabel`控制上述兩個面板控制項 ([按一下以檢視完整大小的影像](batch-inserting-cs/_static/image33.png))
...
[![T按一下處理程序的產品出貨按鈕後顯示他插入介面](batch-inserting-cs/_static/image35.png)](batch-inserting-cs/_static/image34.png)

**圖 12**:按一下處理程序的產品出貨按鈕後顯示插入介面 ([按一下以檢視完整大小的影像](batch-inserting-cs/_static/image36.png))
...
[![A 產品名稱是必要時輸入單位價格](batch-inserting-cs/_static/image38.png)](batch-inserting-cs/_static/image37.png)

**圖 13**:產品名稱是必要時輸入單位價格 ([按一下以檢視完整大小的影像](batch-inserting-cs/_static/image39.png))


[![T三種新 Veggies 已新增供應商 Mayumi s](batch-inserting-cs/_static/image41.png)](batch-inserting-cs/_static/image40.png)

**圖 14**:三個新 Veggies 已新增供應商 Mayumi s ([按一下以檢視完整大小的影像](batch-inserting-cs/_static/image42.png))


[![T他的新產品可在 GridView 的最後一頁](batch-inserting-cs/_static/image44.png)](batch-inserting-cs/_static/image43.png)

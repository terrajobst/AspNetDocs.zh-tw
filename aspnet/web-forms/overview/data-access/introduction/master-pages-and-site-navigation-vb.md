...
[![T他最後結果的本教學課程](master-pages-and-site-navigation-vb/_static/image2.png)](master-pages-and-site-navigation-vb/_static/image1.png)

**圖 1**:最後結果的本教學課程 ([按一下以檢視完整大小的影像](master-pages-and-site-navigation-vb/_static/image3.png))
...
[![Add 新主版頁面的網站](master-pages-and-site-navigation-vb/_static/image6.png)](master-pages-and-site-navigation-vb/_static/image5.png)
...
[![T他主要頁面上，當檢視透過 [設計檢視](master-pages-and-site-navigation-vb/_static/image9.png)](master-pages-and-site-navigation-vb/_static/image8.png)

**圖 4**:主版頁面時檢視透過 設計檢視 ([按一下以檢視完整大小的影像](master-pages-and-site-navigation-vb/_static/image10.png))


## <a name="step-2-adding-a-homepage-to-the-website"></a>步驟 2：新增至網站的首頁
...
[![Add 新的 Web Form，檢查選取的主版頁面的核取方塊](master-pages-and-site-navigation-vb/_static/image12.png)](master-pages-and-site-navigation-vb/_static/image11.png)
...
[![C選擇主要頁面上，此 ASP.NET 頁面應該使用](master-pages-and-site-navigation-vb/_static/image15.png)](master-pages-and-site-navigation-vb/_static/image14.png)
...
[![T他的 ASP.NET 頁面會顯示兩個可編輯和非可編輯區域的 [設計] 檢視](master-pages-and-site-navigation-vb/_static/image18.png)](master-pages-and-site-navigation-vb/_static/image17.png)

**圖 7**:針對 ASP.NET 頁面會顯示兩個可編輯的 [設計] 檢視和非可編輯區域 ([按一下以檢視完整大小的影像](master-pages-and-site-navigation-vb/_static/image19.png))
...
[![Add 網站對應至您的專案](master-pages-and-site-navigation-vb/_static/image22.png)](master-pages-and-site-navigation-vb/_static/image21.png)
...
[![T他網站導覽代表階層式導覽結構](master-pages-and-site-navigation-vb/_static/image25.png)](master-pages-and-site-navigation-vb/_static/image24.png)
...
使用 CSS 樣式所選從[Rachel Andrew](http://www.rachelandrew.co.uk/)的書籍[CSS Anthology:101 不可或缺的秘訣，秘訣&amp;Hacks](https://www.amazon.com/gp/product/0957921888/qid=1137565739/sr=8-1/ref=pd_bbs_1/103-0562306-3386214?n=507846&amp;s=books&amp;v=glance)，則`<ul>`和`<li>`，標記會產生下列視覺化輸出，已有樣式項目：


![由兩個重複項及一些 CSS 功能表](master-pages-and-site-navigation-vb/_static/image27.png)

**圖 11**:由兩個重複項及一些 CSS 功能表
...
**圖 12**:階層連結會顯示目前頁面和網站中的其祖系對應階層架構
...
[![Add Usercontrol 資料夾的新 Web 使用者控制項](master-pages-and-site-navigation-vb/_static/image30.png)](master-pages-and-site-navigation-vb/_static/image29.png)
...
[![T他的使用者控制項必須已加入至 Default.aspx](master-pages-and-site-navigation-vb/_static/image33.png)](master-pages-and-site-navigation-vb/_static/image32.png)

**圖 14**:使用者控制項可讓您有已加入至`Default.aspx`([按一下以檢視完整大小的影像](master-pages-and-site-navigation-vb/_static/image34.png))


[![T他基本報表教學課程將列](master-pages-and-site-navigation-vb/_static/image36.png)](master-pages-and-site-navigation-vb/_static/image35.png)

**圖 15**:基本報表教學課程將列 ([按一下以檢視完整大小的影像](master-pages-and-site-navigation-vb/_static/image37.png))

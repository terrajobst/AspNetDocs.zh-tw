...
## <a name="step-1-creating-a-web-project-and-connecting-to-the-database"></a>步驟 1：建立 Web 專案，並連接至資料庫
...
[![Create New File System-Based 網站](creating-a-data-access-layer-vb/_static/image2.png)](creating-a-data-access-layer-vb/_static/image1.png)
...
[![A資料存取程式碼會轉移到 DAL ll](creating-a-data-access-layer-vb/_static/image6.png)](creating-a-data-access-layer-vb/_static/image5.png)
...
[![C選擇將新的資料集加入至您的專案](creating-a-data-access-layer-vb/_static/image9.png)](creating-a-data-access-layer-vb/_static/image8.png)
...
[![C選擇 Northwind 資料庫，從下拉式清單](creating-a-data-access-layer-vb/_static/image12.png)](creating-a-data-access-layer-vb/_static/image11.png)
...
[![SWeb.config 連接字串 [ave](creating-a-data-access-layer-vb/_static/image15.png)](creating-a-data-access-layer-vb/_static/image14.png)

**圖 6**:儲存連接字串`Web.config`([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image16.png))
...
[![Q查詢使用特定 SQL 陳述式的資料](creating-a-data-access-layer-vb/_static/image18.png)](creating-a-data-access-layer-vb/_static/image17.png)
...
[![Enter 為止 SQL 查詢至文字方塊](creating-a-data-access-layer-vb/_static/image21.png)](creating-a-data-access-layer-vb/_static/image20.png)

**圖 8**:輸入 SQL 查詢至文字方塊 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image22.png))


或者，使用查詢產生器，並以圖形方式建立查詢，如 圖 9 所示。


[![Create 查詢，以圖形方式透過查詢編輯器](creating-a-data-access-layer-vb/_static/image24.png)](creating-a-data-access-layer-vb/_static/image23.png)

**圖 9**:建立查詢，以圖形方式透過查詢編輯器 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image25.png))
...
[![S選擇 [只產生 Insert、 Update 和 Delete 陳述式選項](creating-a-data-access-layer-vb/_static/image27.png)](creating-a-data-access-layer-vb/_static/image26.png)
...
[![C變更 GetProducts 從 GetData 方法名稱](creating-a-data-access-layer-vb/_static/image30.png)](creating-a-data-access-layer-vb/_static/image29.png)
...
[![T他產品 DataTable 和 ProductsTableAdapter 已加入至具類型資料集](creating-a-data-access-layer-vb/_static/image33.png)](creating-a-data-access-layer-vb/_static/image32.png)

**圖 12**:`Products` DataTable 與`ProductsTableAdapter`已加入至具類型資料集 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image34.png))
...
[![T他的產品清單會顯示在 [GridView](creating-a-data-access-layer-vb/_static/image36.png)](creating-a-data-access-layer-vb/_static/image35.png)

**圖 13**:在 GridView 中顯示產品清單 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image37.png))
...
## <a name="step-3-adding-parameterized-methods-to-the-data-access-layer"></a>步驟 3：新增參數化資料存取層的方法
...
[![C選擇建立選取陳述式的傳回資料列](creating-a-data-access-layer-vb/_static/image40.png)](creating-a-data-access-layer-vb/_static/image39.png)
...
[![Enter 為止的查詢只傳回產品中所指定的類別目錄](creating-a-data-access-layer-vb/_static/image43.png)](creating-a-data-access-layer-vb/_static/image42.png)

**圖 16**:輸入查詢只傳回產品在指定的類別 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image44.png))
...
[![C選擇 TableAdapter 方法的名稱](creating-a-data-access-layer-vb/_static/image46.png)](creating-a-data-access-layer-vb/_static/image45.png)
...
[![T顯示用以飲料 」 分類的產品屬於](creating-a-data-access-layer-vb/_static/image50.png)](creating-a-data-access-layer-vb/_static/image49.png)

**圖 19**:會顯示 「 飲料 」 分類這些產品屬於 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image51.png))
...
[![T顯示用以飲料 」 分類中的產品](creating-a-data-access-layer-vb/_static/image53.png)](creating-a-data-access-layer-vb/_static/image52.png)

**圖 20**:會顯示 「 飲料 」 分類中的這些產品 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image54.png))
...
[![E除此之外，每個插入、 更新和刪除要求傳送至立即資料庫](creating-a-data-access-layer-vb/_static/image56.png)](creating-a-data-access-layer-vb/_static/image55.png)
...
[![A變更會同步處理的資料庫時 Update 方法將會叫用](creating-a-data-access-layer-vb/_static/image59.png)](creating-a-data-access-layer-vb/_static/image58.png)

**圖 22**:在叫用 Update 方法時與資料庫同步的所有變更 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image60.png))
...
[![T他 TableAdapter 具有 InsertCommand、 UpdateCommand，以及 DeleteCommand 屬性](creating-a-data-access-layer-vb/_static/image62.png)](creating-a-data-access-layer-vb/_static/image61.png)

**圖 23**:Tableadapter `InsertCommand`， `UpdateCommand`，並`DeleteCommand`屬性 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image63.png))


若要檢查或修改其中任何一個資料庫的命令屬性，按一下`CommandText`子屬性，這會顯示 查詢產生器。


[![C設定執行插入、 更新和刪除陳述式，在 [查詢產生器](creating-a-data-access-layer-vb/_static/image65.png)](creating-a-data-access-layer-vb/_static/image64.png)

**圖 24**:設定`INSERT`， `UPDATE`，並`DELETE`查詢產生器中的陳述式 ([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image66.png))
...
[![Create Products 資料表中加入新資料列的方法](creating-a-data-access-layer-vb/_static/image68.png)](creating-a-data-access-layer-vb/_static/image67.png)
...
[![Augment 查詢傳回 scope_identity （） 值](creating-a-data-access-layer-vb/_static/image71.png)](creating-a-data-access-layer-vb/_static/image70.png)
...
[![Set InsertProduct 新的方法名稱](creating-a-data-access-layer-vb/_static/image74.png)](creating-a-data-access-layer-vb/_static/image73.png)
...
[![C變更純量 ExecuteMode 屬性](creating-a-data-access-layer-vb/_static/image77.png)](creating-a-data-access-layer-vb/_static/image76.png)

**圖 28**:變更`ExecuteMode`屬性，以`Scalar`([按一下以檢視完整大小的影像](creating-a-data-access-layer-vb/_static/image78.png))
...
[![U更新 GetProducts() 方法的選取陳述式](creating-a-data-access-layer-vb/_static/image80.png)](creating-a-data-access-layer-vb/_static/image79.png)
...
[![T他的資料集設計工具後四個 Tableadapter 已新增](creating-a-data-access-layer-vb/_static/image84.png)](creating-a-data-access-layer-vb/_static/image83.png)
...
[![T他 Northwinds 具類型資料集的 XML 結構描述定義 (XSD) 檔案](creating-a-data-access-layer-vb/_static/image87.png)](creating-a-data-access-layer-vb/_static/image86.png)
...
[![T他供應商的公司名稱會列在左側欄中，其在右側的產品](creating-a-data-access-layer-vb/_static/image92.png)](creating-a-data-access-layer-vb/_static/image91.png)

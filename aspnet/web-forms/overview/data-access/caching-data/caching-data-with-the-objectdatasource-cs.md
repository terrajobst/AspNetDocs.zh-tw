...
快取提供經濟實惠的方法並從應用程式的更多效能。 作為[Steven Smith](http://aspadvice.com/blogs/ssmith/)在他的文章指出[ASP.NET 快取：技術和最佳做法](https://msdn.microsoft.com/library/aa478965.aspx):
...
[![Figure 2:您可以將 SectionLevelTutorialListing.ascx 使用者控制項加入 [Default.aspx](caching-data-with-the-objectdatasource-cs/_static/image3.png)](caching-data-with-the-objectdatasource-cs/_static/image2.png)
...
[![C設定使用 ProductsBLL 類別 ObjectDataSource](caching-data-with-the-objectdatasource-cs/_static/image7.png)](caching-data-with-the-objectdatasource-cs/_static/image6.png)
...
[![Set 適當 UpdateProduct 多載來更新 s] 索引標籤下拉式清單](caching-data-with-the-objectdatasource-cs/_static/image10.png)](caching-data-with-the-objectdatasource-cs/_static/image9.png)
...
[![E啟用編輯，排序和分頁的 GridView 支援](caching-data-with-the-objectdatasource-cs/_static/image13.png)](caching-data-with-the-objectdatasource-cs/_static/image12.png)
...
[![E可排序、 Pageable、 可編輯的 GridView 中列為 ach 產品名稱、 類別和價格](caching-data-with-the-objectdatasource-cs/_static/image16.png)](caching-data-with-the-objectdatasource-cs/_static/image15.png)
...
[![Add 標籤和頁面上方的 GridView 的按鈕](caching-data-with-the-objectdatasource-cs/_static/image19.png)](caching-data-with-the-objectdatasource-cs/_static/image18.png)
...
[![W顯示的 henever GridView 會重新繫結至其資料來源，選取觸發的事件](caching-data-with-the-objectdatasource-cs/_static/image22.png)](caching-data-with-the-objectdatasource-cs/_static/image21.png)

**圖 9**:只要 GridView 會重新繫結至其資料來源時，就會顯示選取事件引發 ([按一下以檢視完整大小的影像](caching-data-with-the-objectdatasource-cs/_static/image23.png))


[![C請按一下回傳按鈕將會從其檢視狀態重新建構 GridView](caching-data-with-the-objectdatasource-cs/_static/image25.png)](caching-data-with-the-objectdatasource-cs/_static/image24.png)
...
[![C設定快取其資料，30 秒內的 ObjectDataSource](caching-data-with-the-objectdatasource-cs/_static/image28.png)](caching-data-with-the-objectdatasource-cs/_static/image27.png)
...
- [ASP.NET 快取：技術和最佳做法](https://msdn.microsoft.com/library/aa478965.aspx)

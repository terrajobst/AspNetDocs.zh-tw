...
[![Add 頁面 ObjectDataSource](declarative-parameters-vb/_static/image2.png)](declarative-parameters-vb/_static/image1.png)

**圖 1**:加入至頁面的 ObjectDataSource ([按一下以檢視完整大小的影像](declarative-parameters-vb/_static/image3.png))


這會自動啟動 ObjectDataSource 控制項的 [選擇資料來源] 精靈。 選取`ProductsBLL`類別精靈的第一個畫面。


[![S選擇 ProductsBLL 類別](declarative-parameters-vb/_static/image5.png)](declarative-parameters-vb/_static/image4.png)
...
[![C選擇 GetProductByProductID(productID) 方法](declarative-parameters-vb/_static/image8.png)](declarative-parameters-vb/_static/image7.png)
...
[![A 硬式編碼參數值的 5 用於 productID 參數](declarative-parameters-vb/_static/image11.png)](declarative-parameters-vb/_static/image10.png)

**圖 4**:Hard-Coded 參數值的 5 將會用於`productID`參數 ([按一下以檢視完整大小的影像](declarative-parameters-vb/_static/image12.png))
...
[![I若需 Chef Anton 的 Gumbo 混合會顯示](declarative-parameters-vb/_static/image14.png)](declarative-parameters-vb/_static/image13.png)
...
[![Add 文字方塊中，頁面識別碼 CountryName](declarative-parameters-vb/_static/image17.png)](declarative-parameters-vb/_static/image16.png)
...
[![C選擇 GetSuppliersByCountry(country) 方法](declarative-parameters-vb/_static/image20.png)](declarative-parameters-vb/_static/image19.png)
...
[![Set CountryName 控制項值的參數值](declarative-parameters-vb/_static/image23.png)](declarative-parameters-vb/_static/image22.png)
...
[![T顯示用以來自加拿大的供應商](declarative-parameters-vb/_static/image26.png)](declarative-parameters-vb/_static/image25.png)

**圖 9**:會顯示來自加拿大的這些供應商 ([按一下以檢視完整大小的影像](declarative-parameters-vb/_static/image27.png))
...
[![All 供應商會現在顯示 [預設](declarative-parameters-vb/_static/image29.png)](declarative-parameters-vb/_static/image28.png)

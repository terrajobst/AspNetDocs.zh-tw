...
## <a name="step-1-creating-the-working-with-binary-data-web-pages"></a>步驟 1：使用二進位資料 Web 頁面建立工作
...
[![Add Default.aspx SectionLevelTutorialListing.ascx 使用者控制項](uploading-files-vb/_static/image2.gif)](uploading-files-vb/_static/image1.png)
...
[![B在檔案系統上，或直接在資料庫中，可以儲存二進位資料](uploading-files-vb/_static/image4.gif)](uploading-files-vb/_static/image3.png)

**圖 4**:二進位資料可以儲存在檔案系統上，或直接在資料庫中 ([按一下以檢視完整大小的影像](uploading-files-vb/_static/image4.png))
...
## <a name="step-3-adding-thebrochurepathcolumn-to-thecategoriestable"></a>步驟 3：新增`BrochurePath`資料行`Categories`資料表
...
[![Add BrochurePath Categories 資料表資料行](uploading-files-vb/_static/image5.gif)](uploading-files-vb/_static/image5.png)
...
[![C建立 DataColumn 名為圖片的資料類型是 System.Byte []](uploading-files-vb/_static/image6.gif)](uploading-files-vb/_static/image7.png)
...
[![U更新資料行清單中選取陳述式，也傳回 BrochurePath](uploading-files-vb/_static/image7.gif)](uploading-files-vb/_static/image9.png)
...
[![S選擇 [使用 SQL 陳述式選項](uploading-files-vb/_static/image8.gif)](uploading-files-vb/_static/image11.png)

**圖 8**:選取 使用 SQL 陳述式選項 ([按一下以檢視完整大小的影像](uploading-files-vb/_static/image12.png))


[![Since 查詢會傳回一筆記錄，從 Categories 資料表中，選擇 [選取會傳回資料列](uploading-files-vb/_static/image9.gif)](uploading-files-vb/_static/image13.png)
...
[![C選擇的方法的名稱](uploading-files-vb/_static/image10.gif)](uploading-files-vb/_static/image15.png)
...
[![Add FileUpload 控制項以 ASP.NET 網頁](uploading-files-vb/_static/image12.gif)](uploading-files-vb/_static/image17.png)
...
[![T他的使用者可以選取要上傳的檔案，從他們的電腦，到伺服器](uploading-files-vb/_static/image13.gif)](uploading-files-vb/_static/image19.png)
...
[![T他檔案 EvolutionValley.jpg 已上傳至 Web 伺服器](uploading-files-vb/_static/image14.gif)](uploading-files-vb/_static/image21.png)

**圖 14**:檔案`EvolutionValley.jpg`已上傳至 Web 伺服器 ([按一下以檢視完整大小的影像](uploading-files-vb/_static/image22.png))

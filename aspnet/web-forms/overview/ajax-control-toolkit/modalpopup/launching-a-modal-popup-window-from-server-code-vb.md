...
[![T他的強制回應快顯視窗出現時按一下任一按鈕時](launching-a-modal-popup-window-from-server-code-vb/_static/image2.png)](launching-a-modal-popup-window-from-server-code-vb/_static/image1.png)

...
- **安全性**-開發更安全的應用程式的重要部分是了解它的威脅。 Microsoft 開發了分類威脅的方式：詐騙、 竄改、 否認、 資訊洩漏、 阻絕服務，提高權限 (STRIDE)。 在 ASP.NET Web Forms 中，您可以新增擴充功能和組態選項，可讓您自訂 ASP.NET Web Form 中的各種安全性行為。

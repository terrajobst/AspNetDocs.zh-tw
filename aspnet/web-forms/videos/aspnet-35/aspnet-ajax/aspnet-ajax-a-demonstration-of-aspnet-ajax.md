...
---
# <a name="aspnet-ajax-a-demonstration-of-aspnet-ajax"></a>ASP.NET AJAX： ASP.NET AJAX 的示範

依[Joe Stagner](https://github.com/JoeStagner)

瞭解如何從使用 ASP.NET 2.0 的「待辦事項清單」管理應用程式中輕鬆建立，然後使用 ASP.NET AJAX 延伸模組來增強使用者體驗。

[&#9654;觀看影片（20分鐘）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-ajax-a-demonstration-of-aspnet-ajax)

...
---
# <a name="aspnet-4-quick-hit---imperative-webforms-routing"></a>ASP.NET 4 "快速點擊"-命令式 WebForms 路由

依[Joe Stagner](https://github.com/JoeStagner)

在這段影片中，您將學習如何使用運算式產生器，以命令方式執行 WebForms 路由。 

[&#9654;觀看影片（12分鐘）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-imperative-webforms-routing)

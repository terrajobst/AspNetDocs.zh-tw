...
---
# <a name="aspnet-4-quick-hit---jquery-syntax-for-microsoft-ajax"></a>ASP.NET 4 "快速點擊"-適用于 Microsoft Ajax 的 jQuery 語法

依[Joe Stagner](https://github.com/JoeStagner)

在這段影片中，您將瞭解適用于 Microsoft Ajax 的 jQuery 語法。 

[&#9654;觀看影片（6分鐘）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-jquery-syntax-for-microsoft-ajax)

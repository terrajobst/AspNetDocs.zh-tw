...
---
# <a name="how-do-i-create-excel-spreadsheets-using-linq-to-xml"></a>[How Do I：]使用 LINQ to XML 建立 Excel 試算表？

依[Beth Massi](https://github.com/bethmassi)

Visual Basic 開發人員將學習如何查詢其 SQL Server 資料庫，以便在使用 LINQ to XML 的 Visual Basic 編輯器中輕鬆地直接建立 Excel 試算表。

[&#9654;觀看影片（10分鐘）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-create-excel-spreadsheets-using-linq-to-xml)

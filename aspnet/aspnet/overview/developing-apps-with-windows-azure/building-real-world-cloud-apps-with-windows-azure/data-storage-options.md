...
- [Hadoop 與 HDInsight:在 Azure 中的巨量資料](https://msdn.microsoft.com/magazine/dn385705.aspx)。 Bruno Terkaly 和 Ricardo Villalobos，簡介在 Azure 上的 Hadoop 的 MSDN Magazine 文章。

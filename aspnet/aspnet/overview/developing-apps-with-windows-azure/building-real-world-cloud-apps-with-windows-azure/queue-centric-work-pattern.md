...
- [Microsoft Azure 儲存體佇列第 1 部分：開始使用](http://justazure.com/microsoft-azure-storage-queues-part-1-getting-started/)。 Article by Roman Schacherl.

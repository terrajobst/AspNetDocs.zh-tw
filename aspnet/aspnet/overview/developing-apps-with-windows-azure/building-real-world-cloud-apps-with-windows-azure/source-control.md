...
- [Azure 網站：應用程式字串與連接字串的運作方式](https://azure.microsoft.com/blog/2013/07/17/windows-azure-web-sites-how-application-strings-and-connection-strings-work/)。 說明 Azure 功能，以覆寫`appSettings`並`connectionStrings`中的資料*Web.config*檔案。
...
保留出原始檔控制的機密資訊的其他方法的相關資訊，請參閱[ASP.NET MVC:保留原始檔控制的私用設定現成](http://typecastexception.com/post/2014/04/06/ASPNET-MVC-Keep-Private-Settings-Out-of-Source-Control.aspx)。

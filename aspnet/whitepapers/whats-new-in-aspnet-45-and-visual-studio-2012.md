...
.NET Framework 4.5 和 Windows 8 導入功能，可協助您達成大幅提升效能的 web 伺服器工作負載。 這包括減少 （最多 35%)在這兩個啟動時間和 web 的記憶體使用量中裝載使用 ASP.NET 的網站。
...
您可以立即進行 HTML 編碼資料繫結運算式的結果。 加入冒號 （:）結尾&lt;%# 前置詞標示資料繫結運算式：

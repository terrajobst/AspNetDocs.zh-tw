...
---
# <a name="jquery-datatables-190"></a><span data-ttu-id="fb5da-102">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="fb5da-102">jQuery DataTables 1.9.0</span></span>

<span data-ttu-id="fb5da-103">適用于 jQuery Datatable 外掛程式的下列檔案裝載于 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="fb5da-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>

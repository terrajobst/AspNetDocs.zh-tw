...
>
> 使用[此 GitHub 問題](https://github.com/aspnet/AspNetDocs/issues/116)報告的問題，Microsoft Ajax CDN 使用。
...
#### <a name="jquery-version-340"></a>jQuery 3.4.0 版
...
#### <a name="bootstrap-version-431"></a>啟動程序版本 4.3.1
...
#### <a name="bootstrap-version-341"></a>啟動程序版本 3.4.1

...
title: ASP.NET Web Forms 和 Ajax 4.5.1 |Microsoft Docs
...
ms.locfileid: "78563354"
---
# <a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="a880a-102">ASP.NET Web Forms 與 Ajax 4.5.1</span><span class="sxs-lookup"><span data-stu-id="a880a-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>

<span data-ttu-id="a880a-103">下列檔案裝載于 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="a880a-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="a880a-104">注意：全球化腳本（例如 fr-FR）可在下列資料夾中找到：</span><span class="sxs-lookup"><span data-stu-id="a880a-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>

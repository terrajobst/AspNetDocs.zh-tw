...
title: jquery。驗證版本 1.9 |Microsoft Docs
...
ms.locfileid: "78585068"
---
# <a name="jqueryvalidate-version-19"></a><span data-ttu-id="67773-102">jquery.validate 1.9 版</span><span class="sxs-lookup"><span data-stu-id="67773-102">jquery.validate version 1.9</span></span>

<span data-ttu-id="67773-103">下列檔案裝載于 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="67773-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="67773-104">https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js 的當地語系化檔案，其中 # # 是 loc 程式碼。</span><span class="sxs-lookup"><span data-stu-id="67773-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>

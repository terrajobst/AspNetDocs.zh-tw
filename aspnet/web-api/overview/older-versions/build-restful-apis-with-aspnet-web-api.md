...
3. [練習 3:使用 HTML 用戶端從 Web API](#Exercise3)
...
### <a name="exercise-3-consume-the-web-api-from-an-html-client"></a>練習 3:使用 HTML 用戶端從 Web API
...
## <a name="appendix-c-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a>附錄 c:發行 ASP.NET MVC 4 應用程式使用 Web Deploy

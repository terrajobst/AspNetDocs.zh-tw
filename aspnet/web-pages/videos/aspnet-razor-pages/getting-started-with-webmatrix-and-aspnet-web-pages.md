...
使用 WebMatrix 和 ASP.NET Web Pages 教學課程 accompaniment 到消費者入門的影片

[&#9654;觀看影片（27分鐘）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/getting-started-with-webmatrix-and-aspnet-web-pages)

> [!div class="step-by-step"]
> [下一個](introduction-to-aspnet-web-programming-using-the-razor-syntax.md)

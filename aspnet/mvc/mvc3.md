...
- Scott Guthrie:[宣佈 ASP.NET MVC 3 中，IIS Express、 SQL CE 4，Web 伺服陣列架構、 Orchard，WebMatrix 發行版本](https://weblogs.asp.net/scottgu/archive/2011/01/13/announcing-release-of-asp-net-mvc-3-iis-express-sql-ce-4-web-farm-framework-orchard-webmatrix.aspx)

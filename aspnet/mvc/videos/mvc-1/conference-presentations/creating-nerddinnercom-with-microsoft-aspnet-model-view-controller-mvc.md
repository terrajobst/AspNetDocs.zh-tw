...
沒有投影片。 只是程式碼。 從檔案新功能開始，並在65分鐘內以 ASP.NET、ASP.NET AJAX、Authentication、Authorization、MVC、Microsoft SQL Server 和 jQuery 建立真實的網站。

[&#9654;觀看影片（71分鐘）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/creating-nerddinnercom-with-microsoft-aspnet-model-view-controller-mvc)

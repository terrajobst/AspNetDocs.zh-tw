...
---
# <a name="mvc-music-store-part-2-controllers"></a>MVC 音樂存放區第2部分：控制器

依[Jon Galloway](https://github.com/jongalloway)

Jon 藉由建立一些基本的控制器動作，繼續進行 MVC 音樂存放教學課程。

[&#9654;觀看影片（6分鐘）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/mvc-music-store-part-2-controllers)

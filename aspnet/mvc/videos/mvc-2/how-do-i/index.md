...
- [了解模型、檢視與控制器](understanding-models-views-and-controllers.md)
- [ASP.NET MVC 控制器概觀](aspnet-mvc-controller-overview.md)
- [了解控制器、控制器動作與動作結果](understanding-controllers-controller-actions-and-action-results.md)
- [了解檢視、檢視資料與 HTML 協助程式](understanding-views-view-data-and-html-helpers.md)

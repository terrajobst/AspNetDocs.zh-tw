...
2. *dataValueField*:中的屬性名稱**IEnumerable**包含值的清單。 在上面的範例，`ID`屬性。
3. *dataTextField*:中的屬性名稱**IEnumerable**清單，其中包含要顯示的資訊。 在上面的範例，`name`屬性。

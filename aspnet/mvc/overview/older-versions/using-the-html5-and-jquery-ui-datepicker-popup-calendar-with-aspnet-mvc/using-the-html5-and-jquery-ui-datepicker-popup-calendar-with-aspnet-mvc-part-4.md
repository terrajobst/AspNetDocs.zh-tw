...
大部分的 jQuery 控制項，例如 datepicker 可讓您廣泛地加以自訂。 如需資訊，請參閱[視覺自訂：設計的 jQuery UI 佈景主題](http://learn.jquery.com/jquery-ui/getting-started/#visual-customization-designing-a-jquery-ui-theme)上[jQuery UI](http://learn.jquery.com/jquery-ui/getting-started/)站台。

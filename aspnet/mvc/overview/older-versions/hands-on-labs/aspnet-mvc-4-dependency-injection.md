...
5. 取代 ASP.NET MVC 4 預設相依性解析程式的執行個體**UnityDependencyResolver**。 若要這樣做，請取代**初始化**內容為下列程式碼的方法：
...
### <a name="exercise-3-injecting-action-filters"></a>練習 3:插入動作篩選條件

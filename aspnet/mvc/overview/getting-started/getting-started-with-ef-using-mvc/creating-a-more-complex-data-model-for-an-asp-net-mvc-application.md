...
> * <span data-ttu-id="1f667-117">將程式碼加入至資料庫內容</span><span class="sxs-lookup"><span data-stu-id="1f667-117">Add code to database context</span></span>
...
<span data-ttu-id="1f667-166">執行應用程式，然後按一下 [**學生**] 索引標籤。您會收到下列錯誤：</span><span class="sxs-lookup"><span data-stu-id="1f667-166">Run the application and click the **Students** tab. You get the following error:</span></span>
...
### <a name="the-instructor-navigation-property"></a><span data-ttu-id="1f667-240">講師導覽屬性</span><span class="sxs-lookup"><span data-stu-id="1f667-240">The Instructor Navigation Property</span></span>
...
### <a name="the-databasegenerated-attribute"></a><span data-ttu-id="1f667-252">DatabaseGenerated 屬性</span><span class="sxs-lookup"><span data-stu-id="1f667-252">The DatabaseGenerated Attribute</span></span>
...
## <a name="create-the-department-entity"></a><span data-ttu-id="1f667-262">建立 Department 實體</span><span class="sxs-lookup"><span data-stu-id="1f667-262">Create the Department entity</span></span>
...
## <a name="entity-relationship-diagram"></a><span data-ttu-id="1f667-300">實體關聯性圖表</span><span class="sxs-lookup"><span data-stu-id="1f667-300">Entity relationship diagram</span></span>
...
[<span data-ttu-id="1f667-357">下載已完成的專案</span><span class="sxs-lookup"><span data-stu-id="1f667-357">Download Completed Project</span></span>](https://webpifeed.blob.core.windows.net/webpifeed/Partners/ASP.NET%20MVC%20Application%20Using%20Entity%20Framework%20Code%20First.zip)

## <a name="additional-resources"></a><span data-ttu-id="1f667-358">其他資源</span><span class="sxs-lookup"><span data-stu-id="1f667-358">Additional resources</span></span>

<span data-ttu-id="1f667-359">您可以在[ASP.NET 資料存取-建議的資源](../../../../whitepapers/aspnet-data-access-content-map.md)中找到其他 Entity Framework 資源的連結。</span><span class="sxs-lookup"><span data-stu-id="1f667-359">Links to other Entity Framework resources can be found in the [ASP.NET Data Access - Recommended Resources](../../../../whitepapers/aspnet-data-access-content-map.md).</span></span>

## <a name="next-steps"></a><span data-ttu-id="1f667-360">後續步驟</span><span class="sxs-lookup"><span data-stu-id="1f667-360">Next steps</span></span>

<span data-ttu-id="1f667-361">在本教學課程中，您已：</span><span class="sxs-lookup"><span data-stu-id="1f667-361">In this tutorial, you:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="1f667-362">自訂資料模型</span><span class="sxs-lookup"><span data-stu-id="1f667-362">Customized the data model</span></span>
> * <span data-ttu-id="1f667-363">更新的 Student 實體</span><span class="sxs-lookup"><span data-stu-id="1f667-363">Updated Student entity</span></span>
> * <span data-ttu-id="1f667-364">建立 Instructor 實體</span><span class="sxs-lookup"><span data-stu-id="1f667-364">Created Instructor entity</span></span>
> * <span data-ttu-id="1f667-365">建立 OfficeAssignment 實體</span><span class="sxs-lookup"><span data-stu-id="1f667-365">Created OfficeAssignment entity</span></span>
> * <span data-ttu-id="1f667-366">已修改課程實體</span><span class="sxs-lookup"><span data-stu-id="1f667-366">Modified the Course entity</span></span>
> * <span data-ttu-id="1f667-367">建立部門實體</span><span class="sxs-lookup"><span data-stu-id="1f667-367">Created the Department entity</span></span>
> * <span data-ttu-id="1f667-368">已修改註冊實體</span><span class="sxs-lookup"><span data-stu-id="1f667-368">Modified the Enrollment entity</span></span>
> * <span data-ttu-id="1f667-369">已將程式碼新增至資料庫內容</span><span class="sxs-lookup"><span data-stu-id="1f667-369">Added code to database context</span></span>
> * <span data-ttu-id="1f667-370">將測試資料植入資料庫</span><span class="sxs-lookup"><span data-stu-id="1f667-370">Seeded database with test data</span></span>
> * <span data-ttu-id="1f667-371">新增移轉</span><span class="sxs-lookup"><span data-stu-id="1f667-371">Added a migration</span></span>
> * <span data-ttu-id="1f667-372">更新資料庫</span><span class="sxs-lookup"><span data-stu-id="1f667-372">Updated the database</span></span>

<span data-ttu-id="1f667-373">前進到下一篇文章，以瞭解如何讀取和顯示 Entity Framework 載入導覽屬性的相關資料。</span><span class="sxs-lookup"><span data-stu-id="1f667-373">Advance to the next article to learn how to read and display related data that the Entity Framework loads into navigation properties.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="1f667-374">讀取相關資料</span><span class="sxs-lookup"><span data-stu-id="1f667-374">Read related data</span></span>](reading-related-data-with-the-entity-framework-in-an-asp-net-mvc-application.md)

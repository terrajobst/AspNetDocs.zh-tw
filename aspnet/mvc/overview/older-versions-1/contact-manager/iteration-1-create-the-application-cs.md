...
---
# <a name="iteration-1--create-the-application-c"></a>反復專案 #1 –建立應用程式C#（）

由[Microsoft](https://github.com/microsoft)

[下載程式代碼](iteration-1-create-the-application-cs/_static/contactmanager_1_cs1.zip)
...
**圖 01**： [新增專案] 對話方塊（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image2.png)）
...
**圖 02**： [建立單元測試專案] 對話方塊（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image4.png)）
...
**圖 03**： [方案總管] 視窗（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image6.png)）
...
**圖 04**：建立新的 Microsoft SQL Server Express 資料庫（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image8.png)）
...
**圖 05**：資料庫資料表設計工具（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image10.png)）
...
**圖 06**： [加入新專案] 對話方塊（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image12.png)）
...
**圖 07**：選擇模型內容（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image14.png)）
...
**圖 08**：選擇您的資料連線（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image16.png)）
...
**圖 09**：選擇您的資料庫物件（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image18.png)）
...
**圖 10**： Contact 類別（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image20.png)）
...
**圖 11**：新增主控制器（[按一下以觀看完整大小的影像](iteration-1-create-the-application-cs/_static/image22.png)）
...
**圖 12**：新增索引視圖（[按一下以觀看完整大小的影像](iteration-1-create-the-application-cs/_static/image24.png)）

在 [**加入視圖**] 對話方塊中，核取標示為 [**建立強型別的視圖**] 的核取方塊。 選取 [視圖] 資料類別 ContactManager 和 [視圖內容] 清單。 選取這些選項會產生一個顯示連絡人記錄清單的視圖。
...
**圖 13**： [加入視圖] 對話方塊（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image26.png)）
...
**圖 14**：啟用調試（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image28.png)）
...
**圖 15**：索引視圖（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image30.png)）
...
**圖 16**：新增 Create View （[按一下以觀看完整大小的影像](iteration-1-create-the-application-cs/_static/image32.png)）

在 [**加入視圖**] 對話方塊中，選取 [ **ContactManager** ] 類別和 [查看內容] 的 [**建立**] 選項（請參閱 [圖 17]）。 當您按一下 [**新增**] 按鈕時，就會自動產生 Create view。
...
**圖 17**：查看頁面分解（[按一下以觀看完整大小的影像](iteration-1-create-the-application-cs/_static/image34.png)）
...
**圖 18**： [建立] 視圖（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image36.png)）

## <a name="editing-contacts"></a>編輯連絡人

加入編輯連絡人記錄的功能，與加入建立新連絡人記錄的功能非常類似。 首先，我們需要將兩個新的編輯方法加入至 Home 控制器類別。 這些新的 Edit （）方法包含在 [清單 6] 中。

**清單 6-Controllers\HomeController.cs （含編輯方法）**
...
**圖 19**：新增編輯檢視（[按一下以觀看完整大小的影像](iteration-1-create-the-application-cs/_static/image38.png)）
...
**清單 8-Controllers\HomeController.cs （Delete 方法）**
...
**圖 20**：刪除確認視圖（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image40.png)）
...
**圖 21**：具有編輯連結的索引視圖（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image42.png)）
...
**圖 22**：新增刪除確認視圖（[按一下以觀看完整大小的影像](iteration-1-create-the-application-cs/_static/image44.png)）
...
這個問題很容易修正。 首先，我們需要重構主控制器的名稱。 在 Visual Studio Code 編輯器中開啟 HomeController 類別，以滑鼠右鍵按一下類別的名稱，然後選取 [重構] **、[重新命名**] 功能表選項。 選取此功能表選項會開啟 [重新命名] 對話方塊。
...
**圖 23**：重構控制器名稱（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image46.png)）
...
**圖 24**：使用 [重新命名] 對話方塊（[按一下以查看完整大小的影像](iteration-1-create-the-application-cs/_static/image48.png)）
...
**圖 25**：沒有預設控制器（[按一下以觀看完整大小的影像](iteration-1-create-the-application-cs/_static/image50.png)）
...
> [下一個](iteration-2-make-the-application-look-nice-cs.md)

...
title: '反復專案 #4 –讓應用程式鬆散結合C#（） |Microsoft Docs'
author: microsoft
...
ms.locfileid: "78544454"
---
# <a name="iteration-4--make-the-application-loosely-coupled-c"></a>反復專案 #4 –讓應用程式鬆散結合C#（）

由[Microsoft](https://github.com/microsoft)

[下載程式代碼](iteration-4-make-the-application-loosely-coupled-cs/_static/contactmanager_4_cs1.zip)
...
**清單 1-Models\IContactManagerRepository.cs**
...
**清單 2-Models\EntityContactManagerRepository.cs**
...
**清單 4-Models\ContactManagerService.cs**
...
**清單 5-Models\IContactManagerService.cs**
...
**清單 6-Controllers\ContactController.cs**
...
**清單 7-Models\Validation\ModelStateWrapper.cs**

[!code-csharp[Main](iteration-4-make-the-application-loosely-coupled-cs/samples/sample7.cs)]

**清單 8-Models\Validation\IValidationDictionary.cs**

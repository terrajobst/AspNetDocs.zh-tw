...
title: 使用 MVC 的消費者入門 |Microsoft Docs
author: rick-anderson
description: 這是引進 ASP.NET MVC 的初學者教學課程系列。 建立可從資料庫讀取和寫入的簡單 web 應用程式。
ms.author: riande
ms.date: 11/08/2011
...
ms.locfileid: "78543523"
---
# <a name="getting-started-with-mvc"></a>開始使用 MVC

> 這是引進 ASP.NET MVC 的初學者教學課程系列。 建立可從資料庫讀取和寫入的簡單 web 應用程式。
